...
De acordo com o trabalho de \citeonline{LOPES2014} que realiza a interpretação de grupos através de rótulos com a utilização Redes Neurais, acredita-se que é possível diante desse problema de interpretação dos grupos a criação desses rótulos utilizando outros algoritmos supervisionados, antes não testados.  
