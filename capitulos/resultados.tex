...
Ao observar a tabela \ref{tab:rot:glass:nb} percebe-se que a coluna \textbf{Relevância} obteve porcentagens altas ressaltando nos rótulo de cada grupo os atributos que mais bem se relacionaram no cluster. E em específico no  \textbf{cluster 5} atributo \textbf{Na}, o valor da coluna de \textbf{Relevância = 100\%}, mas na coluna, \textbf{Elem fora da Faixa}, apresentam 2(dois) elementos que não estão sendo representados pelo rótulo. 
...
Por a base apresentar dados desbalenceados e verificando a quantidade de elementos do \textbf{Cluster 5} condicionado com somente nove elementos, onde entre esses elementos, nenhum participa da 1a. faixa, dois estão na 2a. faixa e os restantes (sete) estão na 3a. faixa. Dessa maneira justifica-se o porquê dos dois elementos estarem de fora do rótulo e mostrando que a maioria dos elementos estão sendo representada pelo rótulo.
