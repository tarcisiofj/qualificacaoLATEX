...
Diferente do estudo de  \citeonline{Lopes2016} que em determinada fase de seu trabalho testou um algoritmo de paradigma conexionista para fazer rotulação, esta pesquisa aplicou algoritmos com paradigmas diferentes: bayesiano, simbolista e analogista  \cite{pedro2017}, comprovando que também é possível realizar rotulação de dados.
